    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-6">About Somayaji Industries</h2>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">To provide exceptional fabrication services that exceed customer expectations through quality craftsmanship and innovative solutions.</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <h4 className="font-bold text-gray-900 mb-2">Our Values</h4>
                <p className="text-sm text-gray-600">Quality, integrity, innovation, and customer satisfaction guide every decision we make and every product we create.</p>
              </div>
            </div>
          </div>
